...
getStdin().then((s: string) => {
  ...
  s = s.replace(new RegExp('<table>\\s*<tbody>\\s*<tr>\\s*<td>', 'gi'), '<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">');
  s = s.replace(new RegExp('</td>\\s*</tr>\\s*</tbody>\\s*</table>', 'gi'), '</step>');
  s = s.replace(new RegExp('</td>\\s*</tr>\\s*<tr>\\s*<td>', 'gi'), '</step>\n<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">');

  let re = new RegExp('<step[^<]*>([^<]*(?:<(?!/step>)[^<]*)*)<blockquote>([^<]*(?:<(?!/step>)[^<]*)*)</blockquote>([^<]*(?:<(?!/step>)[^<]*)*)</step>', 'gi');
  s = s.replace(re, '<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">$1$2$3</step>');
  s = s.replace(re, '<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">$1$2$3</step>');
  s = s.replace(re, '<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">$1$2$3</step>');
  ...
  s = s.replace(new RegExp('<step[^<]*>\\s*<p>\\s*[a-z]?\\s*\\.\\s*([^<]*(?:<(?!/step>)[^<]*)*)\\s*</step>', 'gi'), '</li>\n<li>\n<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId"><p>$1</step>');
  s = s.replace(new RegExp('<step[^<]*>\\s*[a-z]?\\s*\\.\\s*([^<]*(?:<(?!/step>)[^<]*)*)\\s*</step>', 'gi'), '</li>\n<li>\n<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId"><p>$1</p></step>');
  s = s.replace(new RegExp('<ol ?[^>]*>', 'gi'), '<ol>');
  s = s.replace(new RegExp('<ol>\\s*</li>', 'gi'), '<ol>');
  s = s.replace(new RegExp('<step[^<]*>\\s*<p>\\s*(<strong>[^<]*(?:<(?!/strong>)[^<]*)*</strong>)\\s*</p>\\s*<ul>', 'gi'), '<p class="v-padding bullet-heading">$1</p>\n<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId"><ul>');
  s = s.replace(new RegExp('<step[^<]*>\\s*((?:<p>[^<]*(?:<(?!/p>)[^<]*)*</p>\\s*)*)<ul>\\s*<li>\\s*<p>([^<]*(?:<(?!/p>)[^<]*)*)</p>\\s*</li>\\s*</ul>((?:\\s*<p>[^<]*(?:<(?!/p>)[^<]*)*</p>)+)', 'gi'), '<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">$1<ul><li>\n<p>$2</p>\n$3\n</li></ul>');
  s = s.replace(new RegExp('\\s*(\\[[^\\]]*\\])\\s*\\.', 'gi'), '. $1');
  s = s.replace(new RegExp('\\s*(\\[[^\\]]*\\])\\s*,', 'gi'), ', $1');
  s = s.replace(new RegExp('<step[^<]*>\\s*(<strong>[^<]*(?:<(?!/step>)[^<]*)*)</step>', 'gi'), '<step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId"><p>$1</p></step>');
  ...
  s = s.replace(new RegExp('<step[^<]*>\\s*<(o|u)l>\\s*<li>([^<]*(?:<(?!/li>)[^<]*)*)</li>\\s*</\\1l>\\s*</step>', 'gi'), '<$1l><li><step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">$2</step></li></$1l>');
  ...
  s = s.replace(new RegExp('<li>\\s*<step[^<]*>(\\s*<p>[^<]*(?:<(?!/div>)[^<]*)*?</p>)\\s*(<p>[a-z]\\.[^<]*(?:<(?!/step>)[^<]*)*)</step>', 'gi'), (match, p1, p2) => {
    let sub = p2;
    sub = sub.replace(new RegExp('</p>\\s*<p>[a-z]\\.\\s*', 'gi'), '</p></step></li>\n<li><step [defaultResponse]="\'goal\'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId"><p>');
    sub = sub.replace(new RegExp('<p>[a-z]\\.\\s*', 'gi'), '<p>');
    return `<li>\n<step [defaultResponse]="'goal'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">\n${p1}</step></li>\n<li><step [defaultResponse]="'goal'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">\n${sub}</step>\n`;
  });
