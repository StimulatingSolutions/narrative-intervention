...
let evaluationTemplate: string = `
  <ol>
    ...
    <li>
      ...
      <step [defaultResponse]="'difficulty'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">
      ...
      <ol>
        <li>
          <step [defaultResponse]="'difficulty'" (onStepClicked)="stepClicked($event)" questionType="difficulty" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">
    ...
    <li>
      ...
      <step [defaultResponse]="'appeal'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">
      ...
      <ol>
        <li>
          <step [defaultResponse]="'appeal'" (onStepClicked)="stepClicked($event)" questionType="appeal" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">
            <p>What we did just now was <u>&nbsp;&nbsp;&nbsp;&nbsp;Think, Ready, Respond&nbsp;&nbsp;&nbsp;&nbsp;</u>.</p>
          </step>
        </li>
        <li>
    ...
    <li>
      ...
      <step [defaultResponse]="'efficacy'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">
...
for (const task of labels.efficacy) {
  evaluationTemplate += `
        <li>
          <step [defaultResponse]="'efficacy'" (onStepClicked)="stepClicked($event)" questionType="efficacy" [allSteps]="steps" [highlightedStepId]="session.readyForResponse" [currentQuestionStepId]="session.questionStepId">
