...
let evaluationTemplate: string = `
  <ol>
    ...
    <li>
      ...
      <step [defaultResponse]="'difficulty'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="suggestedStepId" [currentQuestionStepId]="gettingResponsesFor">
      ...
      <ol>
        <li>
          <step [defaultResponse]="'difficulty'" (onStepClicked)="stepClicked($event)" (onGetResponses)="getResponses($event)" questionType="difficulty" [allSteps]="steps" [highlightedStepId]="suggestedStepId" [currentQuestionStepId]="gettingResponsesFor">
    ...
    <li>
      ...
      <step [defaultResponse]="'appeal'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="suggestedStepId" [currentQuestionStepId]="gettingResponsesFor">
      ...
      <ol>
        <li>
          <step [defaultResponse]="'appeal'" (onStepClicked)="stepClicked($event)" (onGetResponses)="getResponses($event)" questionType="appeal" [allSteps]="steps" [highlightedStepId]="suggestedStepId" [currentQuestionStepId]="gettingResponsesFor">
            <p>What we did just now was <u>&nbsp;&nbsp;&nbsp;&nbsp;Think, Ready, Respond&nbsp;&nbsp;&nbsp;&nbsp;</u>.</p>
          </step>
        </li>
        <li>
    ...
    <li>
      ...
      <step [defaultResponse]="'efficacy'" (onStepClicked)="stepClicked($event)" [allSteps]="steps" [highlightedStepId]="suggestedStepId" [currentQuestionStepId]="gettingResponsesFor">
...
for (const task of labels.efficacy) {
  evaluationTemplate += `
        <li>
          <step [defaultResponse]="'efficacy'" (onStepClicked)="stepClicked($event)" (onGetResponses)="getResponses($event)" questionType="efficacy" [allSteps]="steps" [highlightedStepId]="suggestedStepId" [currentQuestionStepId]="gettingResponsesFor">
