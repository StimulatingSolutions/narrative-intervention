...
let evaluationTemplate: string = `
  <ol>
    ...
    <li>
      ...
      <step defaultResponse="difficulty" (onStepClicked)="stepClicked($event)" (onReady)="stepReady($event)" [session]="session">
      ...
      <ol>
        <li>
          <step defaultResponse="difficulty" (onStepClicked)="stepClicked($event)" questionType="difficulty" (onReady)="stepReady($event)" [session]="session">
    ...
    <li>
      ...
      <step defaultResponse="appeal" (onStepClicked)="stepClicked($event)" (onReady)="stepReady($event)" [session]="session">
      ...
      <ol>
        <li>
          <step defaultResponse="appeal" (onStepClicked)="stepClicked($event)" questionType="appeal" (onReady)="stepReady($event)" [session]="session">
            <p>What we did just now was <u>&nbsp;&nbsp;&nbsp;&nbsp;Think, Ready, Respond&nbsp;&nbsp;&nbsp;&nbsp;</u>.</p>
          </step>
        </li>
        <li>
    ...
    <li>
      ...
      <step defaultResponse="efficacy" (onStepClicked)="stepClicked($event)" (onReady)="stepReady($event)" [session]="session">
...
for (const task of labels.efficacy) {
  evaluationTemplate += `
        <li>
          <step defaultResponse="efficacy" (onStepClicked)="stepClicked($event)" questionType="efficacy" (onReady)="stepReady($event)" [session]="session">
